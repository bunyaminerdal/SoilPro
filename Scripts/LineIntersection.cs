...
namespace ExDesign.Scripts
{
    ...
    {
        //  Returns _Point of intersection if do intersect otherwise default _Point (null)
        public static Point FindIntersection(Line lineA, Line lineB, double tolerance = 0.001)
        {
            ...
            //=> -m2x2 + y2 = c2 -----(2)
            //if line 1 and 2 intersect then x1=x2=x & y1=y2=y where (x,y) is the intersection _Point
            ...
            else
            {
                ...
                //verify by plugging intersection _Point (x, y)
        ...
        // Returns true if given _Point(x,y) is inside the given line segment
